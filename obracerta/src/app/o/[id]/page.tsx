...
export default function ClienteAssinaturaPage() {
  ...
  if (!orcamento) {
    return (
      <div className="min-vh-100 d-flex align-items-center justify-content-center bg-light p-3">
        <div className="card border-0 shadow-sm rounded-4 p-4 text-center" style={{ maxWidth: "400px" }}>
          <i
            className="bi bi-exclamation-triangle display-4 mb-2"
  ...
  return (
    <div className="bg-light min-vh-100 pb-5">
      ...
      <header className="bg-white border-bottom border-light px-3 py-3 sticky-top shadow-2xs">
        <div
        ...
        >
          <div>
            <span
              className="fw-black fs-5 tracking-tight d-block"
            ...
            <small
              ...
              style={{ fontSize: "0.75rem", color: "var(--color-teal-accent)" }}
            >
              Aprovação Digital de Proposta
            </small>
          </div>
          <span className="badge bg-secondary-subtle text-dark font-monospace border px-2 py-1">
            {orcamento.id}
          </span>
        </div>
      </header>
      ...
      <main className="container py-4 px-3" style={{ maxWidth: "500px" }}>
        {assinadoSucesso || orcamento.status === "aprovado" ? (
          <div
            className="card border-0 shadow-sm rounded-4 text-white p-4 text-center mb-3"
            style={{ backgroundColor: "var(--color-teal-dark)" }}
          >
            <i className="bi bi-check-circle-fill display-3 mb-2 text-white"></i>
            ...
            {orcamento.assinaturaUrl && (
              <div className="bg-white rounded-3 p-2 d-inline-block mx-auto border shadow-sm">
